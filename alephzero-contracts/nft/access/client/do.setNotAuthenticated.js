...
//
// bash calling syntax:
// node do.setNotAuthenticated.js <access_selector> <id>
//
...
async function setNotAuthenticated(access_selector, id) {
	...
	try {
		...
		const { gasRequired, storageDeposit, result, output } =
			await contract.query['setNotAuthenticated'](
		...
		// submit doer tx
		let extrinsic = await contract.tx['setNotAuthenticated']
...
setNotAuthenticated(process.argv[2], process.argv[3]);
