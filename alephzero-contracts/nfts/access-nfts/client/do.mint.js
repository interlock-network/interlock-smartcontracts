...
//
// bash calling syntax:
// node call.mint.js <access_selector> <to> <id> <data>
//
...
async function mint(access_selector, account, id) {
	...
	try {
		...
		const txhash = await contract.tx['psp34Mintable::mint']
  			({ storageDepositLimit, gasLimit }, account, {u16: id})
