...
/*
    ...
    pub type Result<T> = core::result::Result<T, PSP22ReceiverError>;

    /// The OtherError result type.
    pub type Result_Other<T> = core::result::Result<T, OtherError>;
*/
...
/////// vesting ////////////////////////////////////////////////////////////
        ...
        pub fn vesting_status(
            ...
            // what happens if cliff hasn't been surpassed yet?
                ...
                timeleft = (this_pool.cliff - self.monthspassed - 1) * ONE_MONTH +
