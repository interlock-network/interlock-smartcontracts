...
const IDENTIFIER_LOG_DATA = JSON.parse((0, fs_1.readFileSync)(process.env.IDENTIFIER_LOG_PATH).toString());
const STAKE_LOG_DATA = JSON.parse((0, fs_1.readFileSync)(process.env.STAKE_LOG_PATH).toString());
async function main() {
