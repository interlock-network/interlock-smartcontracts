...
var CreateUser = function () { return __awaiter(void 0, void 0, void 0, function () {
    var programID, _a, pdaGLOBAL, bumpGLOBAL, count, pdaUSERseed, _b, pdaUSER, bumpUSER, ixDATA, CreateUSERtx, _c, _d, _e, error_1;
    return __generator(this, function (_f) {
        switch (_f.label) {
            ...
            case 5:
                _b = _f.sent(), pdaUSER = _b[0], bumpUSER = _b[1];
            ...
            case 6:
                ...
                // confirmation
                console.log("\n* Successfully created new USER account for '".concat(pdaUSER.toBase58(), "'!\n"));
                return [3 /*break*/, 8];
            case 7:
                error_1 = _f.sent();
                console.log(error_1);
