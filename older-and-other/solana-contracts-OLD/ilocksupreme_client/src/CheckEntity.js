...
var CheckEntity = function () { return __awaiter(void 0, void 0, void 0, function () {
    var programID, ENTITYurl, ENTITYhash, _a, pdaGLOBAL, bumpGLOBAL, _b, pdaENTITY, bumpENTITY, ixDATA, CheckENTITYtx, _c, _d, _e, error_1;
    return __generator(this, function (_f) {
        switch (_f.label) {
            ...
            case 5:
                ...
                ixDATA = [9];
                CheckENTITYtx = new web3_js_1.Transaction().add(new web3_js_1.TransactionInstruction({
                    keys: [
                ...
                _d = (_c = console).log;
                _e = "txhash: ".concat;
                return [4 /*yield*/, (0, web3_js_1.sendAndConfirmTransaction)(utils_2.connection, CheckENTITYtx, [utils_2.ownerKEY])];
            case 6:
                // send transaction
                _d.apply(_c, [_e.apply("txhash: ", [_f.sent()])]);
                // confirmation
                console.log("\n* Successfully checked ENTITY '".concat(ENTITYhash, "'!\n"));
                return [3 /*break*/, 8];
            case 7:
                error_1 = _f.sent();
                console.log(error_1);
