 ...
 * main								*
 ****************************************************************/
var SettleEntity = function () { return __awaiter(void 0, void 0, void 0, function () {
    var programID, ENTITYhash, _a, pdaGLOBAL, bumpGLOBAL, _b, pdaENTITY, bumpENTITY, determination, ixDATA, SettleENTITYtx, _c, _d, _e, _f;
    return __generator(this, function (_g) {
        switch (_g.label) {
            ...
            case 5:
                ...
                _d = (_c = console).log;
                _e = "txhash: ".concat;
                return [4 /*yield*/, (0, web3_js_1.sendAndConfirmTransaction)(utils_2.connection, SettleENTITYtx, [utils_2.ownerKEY])];
            case 6:
                // send transaction
                _d.apply(_c, [_e.apply("txhash: ", [_g.sent()])]);
                // confirmation
                console.log("\n* Successfully settled ENTITY '".concat(ENTITYhash, "'!\n"));
                return [3 /*break*/, 8];
            case 7:
                _f = _g.sent();
                console.log(Error);
