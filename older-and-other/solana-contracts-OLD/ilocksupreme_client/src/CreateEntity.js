 ...
 * main								*
 ****************************************************************/
var CreateEntity = function () { return __awaiter(void 0, void 0, void 0, function () {
    var programID, ENTITYurl, ENTITYhash, _a, pdaGLOBAL, bumpGLOBAL, _b, pdaENTITY, bumpENTITY, count, pdaUSERseed, _c, pdaUSER, bumpUSER, USER, countSTAKE, valence, pdaSTAKEseed, _d, pdaSTAKE, bumpSTAKE, amount, ixDATA, CreateENTITYtx, _e, _f, _g, error_1;
    return __generator(this, function (_h) {
        switch (_h.label) {
            ...
            case 7:
                ...
                valence = parseInt(prompt("Please enter '1' if this entity is good, or '0' if it is bad: "));
            ...
            case 8:
                ...
                ixDATA = [7, bumpSTAKE, bumpENTITY]
                    .concat(pdaSTAKEseed)
                    .concat((0, utils_1.toUTF8Array)(ENTITYhash.toString()).slice(0, 32))
                    .concat(new BN(amount).toArray("le", 16))
                    .concat(valence);
                CreateENTITYtx = new web3_js_1.Transaction().add(new web3_js_1.TransactionInstruction({
                    keys: [
                ...
                _f = (_e = console).log;
                _g = "txhash: ".concat;
                return [4 /*yield*/, (0, web3_js_1.sendAndConfirmTransaction)(utils_2.connection, CreateENTITYtx, [utils_2.ownerKEY])];
            case 9:
                // send transaction
                _f.apply(_e, [_g.apply("txhash: ", [_h.sent()])]);
                // confirmation
                console.log("\n* Successfully created new ENTITY account '".concat(pdaENTITY.toBase58(), "'!\n"));
