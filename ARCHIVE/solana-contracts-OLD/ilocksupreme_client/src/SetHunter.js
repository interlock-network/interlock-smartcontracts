 ...
 * main								*
 ****************************************************************/
var SetHunter = function () { return __awaiter(void 0, void 0, void 0, function () {
    var programID, ENTITYhash, ownerVault, _a, pdaGLOBAL, bumpGLOBAL, _b, pdaUSER, bumpUSER, status, ixDATA, SetHuntertx, _c, _d, _e, _f;
    return __generator(this, function (_g) {
        switch (_g.label) {
            ...
            case 5:
                ...
                ixDATA = [8, status[0]];
                SetHuntertx = new web3_js_1.Transaction().add(new web3_js_1.TransactionInstruction({
                    keys: [
                ...
                _d = (_c = console).log;
                _e = "txhash: ".concat;
                return [4 /*yield*/, (0, web3_js_1.sendAndConfirmTransaction)(utils_2.connection, SetHuntertx, [utils_2.ownerKEY])];
            case 6:
                // send transaction
                _d.apply(_c, [_e.apply("txhash: ", [_g.sent()])]);
                // confirmation
                console.log("\n* Successfully set hunter status for USER '".concat(pdaUSER.toBase58(), "'!\n"));
                return [3 /*break*/, 8];
            case 7:
                _f = _g.sent();
                console.log(Error);
