 ...
 * main								*
 ****************************************************************/
var FillUser = function () { return __awaiter(void 0, void 0, void 0, function () {
    var count, pdaUSERseed, _a, pdaUSER, bumpUSER, amount, ixDATA, FillUSERtx, _b, _c, _d, error_1;
    return __generator(this, function (_e) {
        switch (_e.label) {
            ...
            case 4:
                _a = _e.sent(), pdaUSER = _a[0], bumpUSER = _a[1];
                ...
                ixDATA = [3].concat(new BN(amount).toArray("le", 16));
            ...
            case 5:
                // send transaction
                _c.apply(_b, [_d.apply("txhash: ", [_e.sent()])]);
                // confirmation
