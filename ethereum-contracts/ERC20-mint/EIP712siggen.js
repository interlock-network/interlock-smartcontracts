...
const contractAddress = 1002;
const memberWallet = 1001;
const share = 1000;
const pool = 10;
...
console.log(`v = ${sig.v}`);
console.log(``);
console.log(`encode type = ${encodeType('Validation')}`);
console.log(`type hash = ${ethUtil.bufferToHex(typeHash('Validation'))}`);
console.log(``);
...
console.log(`address = ${ethUtil.bufferToHex(address)}`);
